      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <div className="flex gap-4 justify-center md:justify-start">
            <Link
              href="/register"
              className="bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-orange-700 transition"
            >
              Register Now
            </Link>
            <Link
              href="/login"
              className="border border-blue-600 text-blue-600 px-6 py-3 rounded-xl hover:bg-orange-100 transition"
            >
              Login
            </Link>
          </div>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src="/hero1.png" // 👈 Add image in public folder
            alt="Donate Food"
            width={500}
            height={400}
