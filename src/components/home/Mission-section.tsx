    ...
    <section className="bg-gray-50 py-16 px-4">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="mt-8 flex justify-center gap-6">
          <a href="/register"
            className="bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition"> Become a Donor
          </a>
          <a href="/register"
            className="border border-blue-600 text-blue-600 px-6 py-3 rounded-xl hover:bg-blue-50 transition">Partner as NGO
          </a>
        </div>
      </div>
    </section>
